...
('Salut à tous !', 'salut', 'Bonjour tout le monde !', '<p>Premier article. Connectez vous et éditez le !</p>', '', '', '[[now]]', 1, 'published');
...
('admin', '[[password]]', '[[email]]', 'Administrator', 'Compte par défaut pour Roumpi', 'active', 'administrator');
